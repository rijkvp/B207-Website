  ...
  <body>
    ...
    <nav class="navbar navbar-expand-sm navbar-dark secondnavbar">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar2">
            <ul class="navbar-nav">
                ...
                <li class="nav-item active"><a class="nav-link" href="php_sql.html">PhP & MySQL</a></li>
                <li class="nav-item"><a class="nav-link" href="modelleren.html">Modelleren</a></li>
                <li class="nav-item"><a class="nav-link" href="cyber_security.html">Cyber Security</a></li>
            </ul>
        </div>
    </nav>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6">
                <img class="img-responsive" src="../img/sql.png" alt="CSS 3">
                <h3>MySQL</h3>
